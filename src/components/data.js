const data = [
  ...
  },
  {
    ...
    skills: ["React", "Material-ui", "mongoDB", "Node", "JWT"],
  },
  {
    ...
    demoLink: "https://write-weblog.netlify.app",
    source: "https://github.com/KarthikeyanKanniappan/Blog-frontEnd",
    sourceBack: "https://github.com/KarthikeyanKanniappan/Blog_server",
    skills: ["React", "Redux", "Material-ui", "mongoose", "Node", "JWT"],
  },
  {
    pic: "https://images.unsplash.com/photo-1631427962232-803d4f30c64f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80",
    about: "Personal chat",
    demoLink: "https://illustrious-elf-472acb.netlify.app",
    source: "https://github.com/KarthikeyanKanniappan/chat-app",
    sourceBack: "https://github.com/KarthikeyanKanniappan/Chat-app_server",
    skills: ["React", "Socket.io", "Authorization", "Chakra-ui", "mongoose"],
  },
];
